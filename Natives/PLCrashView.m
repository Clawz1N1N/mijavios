...
- (void)setupErrorCard {
    ...
    if ([self isOOMCrash]) {
        ...
        NSString *suggestion = [NSString stringWithFormat:@"%@ %@",
                                localize(@"crash.suggestion", nil),
                                localize(@"crash.suggestion.oom", nil)];
...
- (void)setupSuggestionsCard {
    ...
    _suggestionsTitleLabel.text = localize(@"crash.quick_fix", nil);
...
- (NSArray<NSDictionary *> *)suggestionsForCrashType {
    ...
    switch (self.crashType) {
        case CrashTypeOOM:
            [result addObject:@{@"icon": @"arrow.down.circle", @"text": localize(@"crash.suggestion.oom_ram", nil)}];
            [result addObject:@{@"icon": @"sparkles", @"text": localize(@"crash.suggestion.oom_getmoream", nil)}];
            [result addObject:@{@"icon": @"trash", @"text": localize(@"crash.suggestion.oom_mods", nil)}];
            [result addObject:@{@"icon": @"arrow.clockwise", @"text": localize(@"crash.suggestion.oom_restart", nil)}];
            break;
        case CrashTypeSegfault:
            [result addObject:@{@"icon": @"cpu", @"text": localize(@"crash.suggestion.segfault_renderer", nil)}];
            [result addObject:@{@"icon": @"shield", @"text": localize(@"crash.suggestion.segfault_jit", nil)}];
            [result addObject:@{@"icon": @"arrow.clockwise", @"text": localize(@"crash.suggestion.segfault_restart", nil)}];
            break;
        case CrashTypeAbort:
            [result addObject:@{@"icon": @"exclamationmark.bubble", @"text": localize(@"crash.suggestion.abort_mods", nil)}];
            [result addObject:@{@"icon": @"cpu", @"text": localize(@"crash.suggestion.abort_renderer", nil)}];
            [result addObject:@{@"icon": @"arrow.clockwise", @"text": localize(@"crash.suggestion.abort_restart", nil)}];
            break;
        case CrashTypeModConflict:
            [result addObject:@{@"icon": @"trash", @"text": localize(@"crash.suggestion.modconflict_remove", nil)}];
            [result addObject:@{@"icon": @"info.circle", @"text": localize(@"crash.suggestion.modconflict_check", nil)}];
            [result addObject:@{@"icon": @"doc.text", @"text": localize(@"crash.suggestion.modconflict_log", nil)}];
            break;
        case CrashTypeMissingLibrary:
            [result addObject:@{@"icon": @"arrow.clockwise.circle", @"text": localize(@"crash.suggestion.missinglib_reinstall", nil)}];
            [result addObject:@{@"icon": @"folder", @"text": localize(@"crash.suggestion.missinglib_check", nil)}];
            [result addObject:@{@"icon": @"wifi", @"text": localize(@"crash.suggestion.missinglib_network", nil)}];
            break;
        case CrashTypeJavaVersionMismatch:
            [result addObject:@{@"icon": @"hammer", @"text": localize(@"crash.suggestion.javaver_change", nil)}];
            [result addObject:@{@"icon": @"info.circle", @"text": localize(@"crash.suggestion.javaver_check", nil)}];
            break;
        case CrashTypeRendererError:
            [result addObject:@{@"icon": @"cpu", @"text": localize(@"crash.suggestion.renderer_switch", nil)}];
            [result addObject:@{@"icon": @"eye.slash", @"text": localize(@"crash.suggestion.renderer_shader", nil)}];
            [result addObject:@{@"icon": @"arrow.down.circle", @"text": localize(@"crash.suggestion.renderer_resolution", nil)}];
            break;
        case CrashTypeModLoadingFailure:
            [result addObject:@{@"icon": @"trash", @"text": localize(@"crash.suggestion.modload_remove", nil)}];
            [result addObject:@{@"icon": @"arrow.clockwise.circle", @"text": localize(@"crash.suggestion.modload_update", nil)}];
            [result addObject:@{@"icon": @"info.circle", @"text": localize(@"crash.suggestion.modload_version", nil)}];
            break;
        case CrashTypeJavaException:
            [result addObject:@{@"icon": @"doc.text", @"text": localize(@"crash.suggestion.java_log", nil)}];
            [result addObject:@{@"icon": @"trash", @"text": localize(@"crash.suggestion.java_mods", nil)}];
            [result addObject:@{@"icon": @"arrow.clockwise", @"text": localize(@"crash.suggestion.java_restart", nil)}];
            break;
...
- (void)setupButtonsIntoContainer:(UIStackView *)container {
    ...
    _restartButton = [self createButtonWithTitle:localize(@"crash.restart_launcher", nil)
...
- (NSString *)crashReasonText {
    ...
    switch (self.crashType) {
        ...
        case CrashTypeTerminated:
            ...
            break;
        case CrashTypeModConflict:
            reason = localize(@"crash.reason.mod_conflict", nil);
            break;
        case CrashTypeMissingLibrary:
            reason = localize(@"crash.reason.missing_library", nil);
            break;
        case CrashTypeJavaVersionMismatch:
            reason = localize(@"crash.reason.java_version", nil);
            break;
        case CrashTypeRendererError:
            reason = localize(@"crash.reason.renderer", nil);
            break;
        case CrashTypeModLoadingFailure:
            reason = localize(@"crash.reason.mod_loading", nil);
            break;
        case CrashTypeJavaException:
            reason = localize(@"crash.reason.java_exception", nil);
            break;
        case CrashTypeUnknown:
            reason = [NSString stringWithFormat:localize(@"crash.reason.unknown", nil), _exitCode];
            break;
    }
